# Generated by Powerlevel10k configuration wizard on 2020-02-23 at 22:16 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 02963.
# Wizard options: nerdfont-complete + powerline, small icons, lean_8colors, 2 lines,
# disconnected, left frame, blue-ornaments, compact, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n%F{7}@%F{3}%m'
